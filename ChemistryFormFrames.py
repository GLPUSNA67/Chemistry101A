...
def check_entry_changes():
    ...
    #db[eci_1]['qty'] = eci_1_qty    #TypeError: unhashable type: 'StringVar'
    #db[eci_1]['qty'] = float(e_eci_1_qty.get())
    ...
    #print("mass_eci_1 is ", db[eci_1]['mass'])
    #total_mass = eci_1_qty.get() * 3   # ''' Works'''
    ''' The following works. '''
...
cb_1_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_1_temp_units, width=10) # eci_temp_1_units
...
cb_1_Press_Units = Combobox(root, values=press_umits, textvariable=eci_1_press_units, width=10)   #, width=12)
...
cb_4_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_4_temp_units, width=10)
...
cb_4_Press_Units = Combobox(root, values=press_umits, textvariable=eci_4_press_units, width=10)   #, width=12)
...
cb_2_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_2_temp_units, width=10)
...
cb_2_Press_Units = Combobox(root, values=press_umits, textvariable=eci_2_press_units, width=10)
...
cb_5_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_5_temp_units, width=10)
...
cb_5_Press_Units = Combobox(root, values=press_umits, textvariable=eci_5_press_units, width=10)
...
cb_3_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_3_temp_units, width=10)
...
cb_3_Press_Units = Combobox(root, values=press_umits, textvariable=eci_3_press_units, width=10)
...
cb_6_Temp_Units = Combobox(root, values=temp_umits, textvariable=eci_6_temp_units, width=10)
...
cb_6_Press_Units = Combobox(root, values=press_umits, textvariable=eci_6_press_units, width=10)
