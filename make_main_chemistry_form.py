...
def select_eci_1_type(eventObject):
    cb_1_type = mcf.cb_Select_CB1.get()  # use cb_1_type as a local variable to improve readability
    eci_d['eci_1']['eci_type'] = mcf.cb_Select_CB1.get()
    ...
    if cb_1_type == 'elements':
        mcf.cb_eci_1['values'] = elements_symbols_list
        mcf.cb_eci_1_N['values'] = elements_name_list
    elif cb_1_type == 'compounds':
        mcf.cb_eci_1['values'] = compound_symbols_list
        mcf.cb_eci_1_N['values'] = compound_names_list
    elif cb_1_type == 'ions':
        mcf.cb_eci_1['values'] = ion_symbols_list
        mcf.cb_eci_1_N['values'] = ion_names_list
    else:
        print("Error is select_eci_1_type")


def select_eci_2_type(eventObject):
    cb_2_type = mcf.cb_Select_CB2.get()
    print("cb_2_type is ", cb_2_type)
    eci_d['eci_2']['eci_type'] = mcf.cb_Select_CB2.get()
    if cb_2_type == 'elements':
        mcf.cb_eci_2['values'] = elements_symbols_list
        mcf.cb_eci_2_N['values'] = elements_name_list
    elif cb_2_type == 'compounds':
        mcf.cb_eci_2['values'] = compound_symbols_list
        mcf.cb_eci_2_N['values'] = compound_names_list
    elif cb_2_type == 'ions':
        mcf.cb_eci_2['values'] = ion_symbols_list
        mcf.cb_eci_2_N['values'] = ion_names_list
    else:
        print("Error is select_eci_2_type")


def select_eci_3_type(eventObject):
    cb_3_type = mcf.cb_Select_CB3.get()
    print("cb_3_type is ", cb_3_type)
    eci_d['eci_3']['eci_type'] = mcf.cb_Select_CB3.get()
    if cb_3_type == 'elements':
        mcf.cb_eci_3['values'] = elements_symbols_list
        mcf.cb_eci_3_N['values'] = elements_name_list
    elif cb_3_type == 'compounds':
        mcf.cb_eci_3['values'] = compound_symbols_list
        mcf.cb_eci_3_N['values'] = compound_names_list
    elif cb_3_type == 'ions':
        mcf.cb_eci_3['values'] = ion_symbols_list
        mcf.cb_eci_3_N['values'] = ion_names_list
    else:
        print("Error is select_eci_3_type")


def select_eci_4_type(eventObject):
    cb_4_type = mcf.cb_Select_CB4.get()
    print("cb_4_type is ", cb_4_type)
    eci_d['eci_4']['eci_type'] = mcf.cb_Select_CB4.get()
    if cb_4_type == 'elements':
        mcf.cb_eci_4['values'] = elements_symbols_list
        mcf.cb_eci_4_N['values'] = elements_name_list
    elif cb_4_type == 'compounds':
        mcf.cb_eci_4['values'] = compound_symbols_list
        mcf.cb_eci_4_N['values'] = compound_names_list
    elif cb_4_type == 'ions':
        mcf.cb_eci_4['values'] = ion_symbols_list
        mcf.cb_eci_4_N['values'] = ion_names_list
    else:
        print("Error is select_eci_4_type")


def select_eci_5_type(eventObject):
    cb_5_type = mcf.cb_Select_CB5.get()
    print("cb_5_type is ", cb_5_type)
    eci_d['eci_5']['eci_type'] = mcf.cb_Select_CB5.get()
    if cb_5_type == 'elements':
        mcf.cb_eci_5['values'] = elements_symbols_list
        mcf.cb_eci_5_N['values'] = elements_name_list
    elif cb_5_type == 'compounds':
        mcf.cb_eci_5['values'] = compound_symbols_list
        mcf.cb_eci_5_N['values'] = compound_names_list
    elif cb_5_type == 'ions':
        mcf.cb_eci_5['values'] = ion_symbols_list
        mcf.cb_eci_5_N['values'] = ion_names_list
    else:
        print("Error is select_eci_5_type")


def select_eci_6_type(eventObject):
    cb_6_type = mcf.cb_Select_CB6.get()
    print("cb_6_type is ", cb_6_type)
    eci_d['eci_6']['eci_type'] = mcf.cb_Select_CB6.get()
    if cb_6_type == 'elements':
        mcf.cb_eci_6['values'] = elements_symbols_list
        mcf.cb_eci_6_N['values'] = elements_name_list
    elif cb_6_type == 'compounds':
        mcf.cb_eci_6['values'] = compound_symbols_list
        mcf.cb_eci_6_N['values'] = compound_names_list
    elif cb_6_type == 'ions':
        mcf.cb_eci_6['values'] = ion_symbols_list
        mcf.cb_eci_6_N['values'] = ion_names_list
    else:
...
def check_entry_changes():
    ...
    eci_1 = mcf.cb_eci_1.get()
    eci_1_qty = mcf.e_eci_1_qty.get()
    eci_1_M_qty = mcf.e_eci_1_M_qty.get()
    eci_1_mass = getdouble(db[eci_1]['mass'])  # don't use float due to precision errors
    eci_d['eci_1']['qty'] = eci_1_qty
    print("e_eci_1_qty.get() is ", mcf.e_eci_1_qty.get())
    print("eci_db['eci_1']['qty'] is ", eci_d['eci_1']['qty'])
    print("e_eci_1_M_qty.get() is ", mcf.e_eci_1_M_qty.get())
    ...
    ''' The following works. '''
    total_mass = getdouble(mcf.e_eci_1_qty.get()) * eci_1_mass  # float(db[eci_1]['mass'])
...
def Continue():
    ...
    process_selected = mcf.cb_Select_Process.get()
...
def Calculate_eci_variables():
    ...
    if not eci_1_M_qty == "":
        ...
        mcf.e_eci_1_qty.delete(0, END)
        mcf.e_eci_1_qty.insert(0, m_mass)
        mcf.e_Explanation.insert(END, m_mass)
...
def Oxidation_Reduction():
    ...
    mcf.e_Explanation.insert(tk.END, "Oxidation_Reduction process entered\n")

    Oxidation_Rate()
    cb_1_type = mcf.cb_Select_CB1.get()  # Get the selected type of: element, compound, or ion
    ...
    if cb_1_type == 'elements':
        ...
        # eci_1 = cb_eci_1.get()
        # print('eci_1 = ', eci_1)
        mcf.e_Explanation.insert(tk.END, "Error in Oxidation_Reduction eci_1 can't process compounds yet")
    else:
        print("Oxidation_Reduction process eci_1 else clause")
    cb_2_type = mcf.cb_Select_CB2.get()  # Get the selected type of: element, compound, or ion
    print('eci_2_type = ', cb_2_type)
    if cb_2_type == 'elements':
        eci_2 = mcf.cb_eci_2.get()
        print('eci_2 = ', eci_2)
        '''  *** The following works! '''
    ...
    cb_3_type = mcf.cb_Select_CB3.get()  # Get the selected type of: element, compound, or ion
    print('eci_3_type = ', cb_3_type)
    eci_3 = mcf.cb_eci_3.get()
    print('eci_3 = ', eci_3)
    if cb_3_type == 'elements':
        # eci_3 = cb_eci_3.get()
        # print('eci_3 = ', eci_3)
        ...
        mcf.e_Explanation.insert(tk.END, "Error in Oxidation_Reduction process eci_3 else clause\n")
...
def Precipitation():
    """ print("Pressed update_record button") """
    mcf.e_Explanation.insert(tk.END, "Precipitation process entered\n")
    # print("Precipitation process entered")


def Oxidation_Rate():
    cb_1_type = mcf.cb_Select_CB1.get()
    cb_2_type = mcf.cb_Select_CB2.get()
    cb_3_type = mcf.cb_Select_CB3.get()
    if cb_1_type == 'elements' and cb_2_type == 'elements' and cb_3_type == 'elements' or cb_3_type == "":
        ...
        mcf.e_Explanation.insert(tk.END, "Oxidation_Rate process fell through to else clause\n")
...
def Oxidation_Rate_Compounds():
    mcf.e_Explanation.insert(tk.END, "Entered Oxidation_Rate_Compounds process\n")


def Oxidation_Rate_Ions():
    mcf.e_Explanation.insert(tk.END, "Entered Oxidation_Rate_Ions process\n")
...
def Oxidation_Rate_Elements():
    ...
    mcf.cb_eci_1_units.set('grams')
    mcf.cb_eci_2_units.set('grams')
    mcf.cb_eci_4_units.set('grams')

    mcf.e_Explanation.insert(tk.END, "Oxidation_Rate_Elements process entered\n")
    ...
    eci_1_temp_units = mcf.cb_1_Temp_Units.get()
    eci_d['eci_2']['eci'] = mcf.cb_eci_2.get()
    eci_d['eci_3']['eci'] = mcf.cb_eci_3.get()
    ...
    if eci_1_valence.isnumeric():
        ...
        if eci_2_valence.isnumeric():
            ...
            if eci_2_group == "7A":
                ...
                if eci_1_electronegativity < eci_2_electronegativity:
                    ...
                    eci_1_M_qty = 1
                    mcf.e_eci_1_M_qty.delete(0)
                    mcf.e_eci_1_M_qty.insert(0, eci_1_M_qty)
                    eci_2_M_qty = eci_1_valence  # This is correct. Cross assign valences to quantities
                    mcf.e_eci_2_M_qty.delete(0, END)
                    mcf.e_eci_2_M_qty.insert(0, eci_2_M_qty)
                    ...
                    mcf.cb_eci_4.set(eci_4)
                    mcf.e_eci_4_M_qty.delete(0, END)
                    mcf.e_eci_4_M_qty.insert(0, 1)
                    print("eci_4 is ", eci_4)
                    print("e_eci_1_M_qty is ", mcf.e_eci_1_M_qty.get())
                    print("e_eci_2_M_qty is ", mcf.e_eci_2_M_qty.get())
                ...
                if eci_1_electronegativity < eci_2_electronegativity:
                    ...
                    if eci_2_valence == -2 and eci_1_valence == "1":
                        ...
                        eci_4 = eci_1 + eci_2
                        mcf.e_eci_1_M_qty.delete(0)
                        mcf.e_eci_1_M_qty.insert(0, 1)
                        mcf.e_eci_2_M_qty.delete(0, END)
                        mcf.e_eci_2_M_qty.insert(0, 1)
                    ...
                    mcf.e_eci_1_qty.delete(0)
                    mcf.e_eci_1_qty.insert(0, eci_1_massa)
                    mcf.e_eci_2_qty.delete(0)
                    mcf.e_eci_2_qty.insert(0, float(eci_2_M_qty) * float(eci_2_mass))
                    # eci_1_M_qty = 1
        ...
        mcf.e_Explanation.insert(tk.END, "In Oxidation_Rate process else clause\n")


def Acid_Base():
    mcf.e_Explanation.insert(tk.END, "Acid_Base process entered\n")


def Decompose():
    mcf.e_Explanation.insert(tk.END, "Decompose process entered\n")


def Refine():
    mcf.e_Explanation.insert(tk.END, "Refine process entered\n")


def Metathesis():
    mcf.e_Explanation.insert(tk.END, "Metathesis process entered\n")


def Oxidization():
    mcf.e_Explanation.insert(tk.END, "Oxidization process entered\n")


def Reduction():
    mcf.e_Explanation.insert(tk.END, "Reduction process entered\n")
...
def Synthesis():
    ...
    '''
    mcf.e_Explanation.insert(tk.END, "Synthesis process entered\n")
...
def setClassItem(eventObject):
    ...
    mcf.e_Explanation.insert(tk.END, "setClassItem process entered\n")
    ...
    if cb_1_type == 'elements':
        ...
        eci_1_name = db[eci_1]['name']
        mcf.e_Explanation.insert(tk.END, "db[eci_1]['mass'] is ", eci_temp_1_qty, '\n')
...
def setSelectedItemName(ComboboxSelected):
    ...
    eci_2 = mcf.cb_eci_2.get()
    eci_3 = mcf.cb_eci_3.get()
    eci_4 = mcf.cb_eci_4.get()
    eci_5 = mcf.cb_eci_5.get()
    eci_6 = mcf.cb_eci_6.get()
    eci_1_name = mcf.cb_eci_1_N.get()
    eci_2_name = mcf.cb_eci_2_N.get()
    eci_3_name = mcf.cb_eci_3_N.get()
    eci_4_name = mcf.cb_eci_4_N.get()
    eci_5_name = mcf.cb_eci_5_N.get()
    eci_6_name = mcf.cb_eci_6_N.get()
    # print("eci_1_name is ", eci_1_name)
    if cb_1_type == 'elements':
        try:
            if not eci_1_name == db[eci_1]['name']:
                mcf.cb_eci_1_N.set(db[eci_1]['name'])   # This works
                eci_1_d['eci'] = mcf.cb_eci_1.get()
            ...
            mcf.cb_eci_1_N.set("not a valid key")
    elif cb_1_type == 'compounds':
        try:
            if not eci_1_name == c_db[eci_1]['name']:
                mcf.cb_eci_1_N.set(c_db[eci_1]['name'])
                eci_1_d['eci'] = mcf.cb_eci_1.get()
        ...
        try:
            if not eci_1_name == i_db[eci_1]['name']:
                mcf.cb_eci_1_N.set(i_db[eci_1]['name'])
                eci_1_d['eci'] = mcf.cb_eci_1.get()
                eci_1_d['name'] = eci_1_name
        except KeyError:
            mcf.cb_eci_1_N.set("not a valid key")
    if cb_2_type == 'elements':
        try:
            if not eci_2_name == db[eci_2]['name']:
                mcf.cb_eci_2_N.set(db[eci_2]['name'])
                eci_2_d['eci'] = mcf.cb_eci_2.get()
                eci_2_d['name'] = eci_2_name
        except KeyError:
            mcf.cb_eci_2_N.set("not a valid key")
    elif cb_2_type == 'compounds':
        try:
            if not eci_2_name == c_db[eci_2]['name']:
                mcf.cb_eci_2_N.set(c_db[eci_2]['name'])
                eci_2_d['eci'] = mcf.cb_eci_2.get()
                eci_2_d['name'] = eci_2_name
        except KeyError:
            mcf.cb_eci_2_N.set("not a valid key")
        ...
        try:
            if not eci_2_name == i_db[eci_2]['name']:
                mcf.cb_eci_2_N.set(i_db[eci_2]['name'])
                eci_2_d['eci'] = mcf.cb_eci_2.get()
                eci_2_d['name'] = eci_2_name
        except KeyError:
            mcf.cb_eci_2_N.set("not a valid key")
    if cb_3_type == 'elements':
        try:
            if not eci_3_name == db[eci_3]['name']:
                mcf.cb_eci_3_N.set(db[eci_3]['name'])
                eci_3_d['eci'] = mcf.cb_eci_3.get()
                eci_3_d['name'] = eci_3_name
        except KeyError:
            mcf.cb_eci_3_N.set("not a valid key")
    elif cb_3_type == 'compounds':
        try:
            if not eci_3_name == c_db[eci_3]['name']:
                mcf.cb_eci_3_N.set(c_db[eci_3]['name'])
                eci_3_d['eci'] = mcf.cb_eci_3.get()
                eci_3_d['name'] = eci_3_name
        except KeyError:
            mcf.cb_eci_3_N.set("not a valid key")
        ...
        try:
            if not eci_3_name == i_db[eci_3]['name']:
                mcf.cb_eci_3_N.set(i_db[eci_3]['name'])
                eci_3_d['eci'] = mcf.cb_eci_3.get()
                eci_3_d['name'] = eci_3_name
        except KeyError:
            mcf.cb_eci_3_N.set("not a valid key")
    if cb_4_type == 'elements':
        try:
            if not eci_4_name == db[eci_4]['name']:
                mcf.cb_eci_4_N.set(db[eci_4]['name'])
                eci_4_d['eci'] = mcf.cb_eci_4.get()
                eci_4_d['name'] = eci_4_name
        except KeyError:
            mcf.cb_eci_4_N.set("not a valid key")
    elif cb_4_type == 'compounds':
        try:
            if not eci_4_name == c_db[eci_4]['name']:
                mcf.cb_eci_4_N.set(c_db[eci_4]['name'])
                eci_4_d['eci'] = mcf.cb_eci_4.get()
                eci_4_d['name'] = eci_4_name
        except KeyError:
            mcf.cb_eci_4_N.set("not a valid key")
        ...
        try:
            if not eci_4_name == i_db[eci_4]['name']:
                mcf.cb_eci_4_N.set(i_db[eci_4]['name'])
                eci_4_d['eci'] = mcf.cb_eci_4.get()
                eci_4_d['name'] = eci_4_name
        except KeyError:
            mcf.b_eci_4_N.set("not a valid key")
    if cb_5_type == 'elements':
        try:
            if not eci_5_name == db[eci_5]['name']:
                mcf.cb_eci_5_N.set(db[eci_5]['name'])
                eci_5_d['eci'] = mcf.cb_eci_5.get()
                eci_5_d['name'] = eci_5_name
        except KeyError:
            mcf.cb_eci_5_N.set("not a valid key")
    elif cb_5_type == 'compounds':
        try:
            if not eci_5_name == c_db[eci_5]['name']:
                mcf.cb_eci_5_N.set(c_db[eci_5]['name'])
                eci_5_d['eci'] = mcf.cb_eci_5.get()
                eci_5_d['name'] = eci_5_name
        except KeyError:
            mcf.cb_eci_5_N.set("not a valid key")
        ...
        try:
            if not eci_5_name == i_db[eci_5]['name']:
                mcf.cb_eci_5_N.set(i_db[eci_5]['name'])
                eci_5_d['eci'] = mcf.cb_eci_5.get()
                eci_5_d['name'] = eci_5_name
        except KeyError:
            mcf.cb_eci_5_N.set("not a valid key")
    if cb_6_type == 'elements':
        try:
            if not eci_6_name == db[eci_6]['name']:
                mcf.cb_eci_6_N.set(db[eci_6]['name'])
                eci_6_d['eci'] = mcf.cb_eci_6.get()
                eci_6_d['name'] = eci_6_name
        except KeyError:
            mcf.cb_eci_6_N.set("not a valid key")
    elif cb_6_type == 'compounds':
        try:
            if not eci_6_name == c_db[eci_6]['name']:
                mcf.cb_eci_6_N.set(c_db[eci_6]['name'])
                eci_6_d['eci'] = mcf.cb_eci_6.get()
                eci_6_d['name'] = eci_6_name
        except KeyError:
            mcf.cb_eci_6_N.set("not a valid key")
        ...
        try:
            if not eci_6_name == i_db[eci_6]['name']:
                mcf.cb_eci_6_N.set(i_db[eci_6]['name'])
                eci_6_d['eci'] = mcf.cb_eci_6.get()
                eci_6_d['name'] = eci_6_name
        except KeyError:
            mcf.cb_eci_6_N.set("not a valid key")
...
def setSelectedItemFormula(ComboboxSelected):
    eci_1_N = mcf.cb_eci_1_N.get()
    eci_2_N = mcf.cb_eci_2_N.get()
    eci_3_N = mcf.cb_eci_3_N.get()
    eci_4_N = mcf.cb_eci_4_N.get()
    eci_5_N = mcf.cb_eci_5_N.get()
    eci_6_N = mcf.cb_eci_6_N.get()
    cb_1_type = mcf.cb_Select_CB1.get()
    cb_2_type = mcf.cb_Select_CB2.get()
    cb_3_type = mcf.cb_Select_CB3.get()
    cb_4_type = mcf.cb_Select_CB4.get()
    ...
    cb_6_type = mcf.cb_Select_CB6.get()
    if cb_1_type == 'elements':
        if not eci_1 == element_names_Dict[mcf.cb_eci_1_N.get()]:
            mcf.cb_eci_1.set(element_names_Dict[mcf.cb_eci_1_N.get()])
    elif cb_1_type == 'compounds':
        if not eci_1 == compounds_names_dict[mcf.cb_eci_1_N.get()]:
            mcf.cb_eci_1.set(compounds_names_dict[mcf.cb_eci_1_N.get()])
        else:
            print('eci_1 is already correct and doesn\'t need to be reset')
    elif cb_1_type == 'ions':
        if not eci_1 == ion_names_dict[mcf.cb_eci_1_N.get()]:
            mcf.cb_eci_1.set(ion_names_dict[mcf.cb_eci_1_N.get()])
    if cb_2_type == 'elements':
        if not eci_2 == element_names_Dict[mcf.cb_eci_2_N.get()]:
            mcf.cb_eci_2.set(element_names_Dict[mcf.cb_eci_2_N.get()])
    elif cb_2_type == 'compounds':
        if not eci_2 == compounds_names_dict[mcf.cb_eci_2_N.get()]:
            mcf.cb_eci_2.set(compounds_names_dict[mcf.cb_eci_2_N.get()])
    elif cb_2_type == 'ions':
        if not eci_2 == ion_names_dict[mcf.cb_eci_2_N.get()]:
            mcf.cb_eci_2.set(ion_names_dict[mcf.cb_eci_2_N.get()])
    if cb_3_type == 'elements':
        if not eci_3 == element_names_Dict[mcf.cb_eci_3_N.get()]:
            mcf.cb_eci_3.set(element_names_Dict[mcf.cb_eci_3_N.get()])
    elif cb_3_type == 'compounds':
        if not eci_3 == compounds_names_dict[mcf.cb_eci_3_N.get()]:
            mcf.cb_eci_3.set(compounds_names_dict[mcf.cb_eci_3_N.get()])
    elif cb_3_type == 'ions':
        if not eci_3 == ion_names_dict[mcf.cb_eci_3_N.get()]:
            mcf.cb_eci_3.set(ion_names_dict[mcf.cb_eci_3_N.get()])
    if cb_4_type == 'elements':
        if not eci_4 == element_names_Dict[mcf.cb_eci_4_N.get()]:
            mcf.cb_eci_4.set(element_names_Dict[mcf.cb_eci_4_N.get()])
    elif cb_4_type == 'compounds':
        if not eci_4 == compounds_names_dict[mcf.cb_eci_4_N.get()]:
            mcf.cb_eci_4.set(compounds_names_dict[mcf.cb_eci_4_N.get()])
    elif cb_4_type == 'ions':
        if not eci_4 == ion_names_dict[mcf.cb_eci_4_N.get()]:
            mcf.cb_eci_4.set(ion_names_dict[mcf.cb_eci_4_N.get()])
    if cb_5_type == 'elements':
        if not eci_5 == element_names_Dict[mcf.cb_eci_5_N.get()]:
            mcf.cb_eci_5.set(element_names_Dict[mcf.cb_eci_5_N.get()])
    elif cb_5_type == 'compounds':
        if not eci_5 == compounds_names_dict[mcf.cb_eci_5_N.get()]:
            mcf.cb_eci_5.set(compounds_names_dict[mcf.cb_eci_5_N.get()])
    elif cb_5_type == 'ions':
        if not eci_5 == ion_names_dict[mcf.cb_eci_5_N.get()]:
            mcf.mcf.cb_eci_5.set(ion_names_dict[mcf.cb_eci_5_N.get()])
    if cb_6_type == 'elements':
        if not eci_6 == element_names_Dict[mcf.cb_eci_6_N.get()]:
            mcf.cb_eci_6.set(element_names_Dict[mcf.cb_eci_6_N.get()])
    elif cb_6_type == 'compounds':
        if not eci_6 == compounds_names_dict[mcf.cb_eci_6_N.get()]:
            mcf.cb_eci_6.set(compounds_names_dict[mcf.cb_eci_6_N.get()])
    elif cb_6_type == 'ions':
        if not eci_6 == ion_names_dict[mcf.cb_eci_6_N.get()]:
            mcf.cb_eci_6.set(ion_names_dict[mcf.cb_eci_6_N.get()])
...
def eci_units_selected(*arg):
    ...
    eci_1_units = mcf.cb_eci_1_units.get()
    eci_2_units = mcf.cb_eci_2_units.get()
    eci_3_units = mcf.cb_eci_3_units.get()
    eci_4_units = mcf.cb_eci_4_units.get()
    eci_5_units = mcf.cb_eci_5_units.get()
    eci_6_units = mcf.cb_eci_6_units.get()
    eci_d['eci_1']['display_units'] = mcf.cb_eci_1_units.get()
    eci_d['eci_2']['display_units'] = mcf.cb_eci_2_units.get()
    eci_d['eci_3']['display_units'] = mcf.cb_eci_3_units.get()
    eci_d['eci_4']['display_units'] = mcf.cb_eci_4_units.get()
    eci_d['eci_5']['display_units'] = mcf.cb_eci_5_units.get()
    eci_d['eci_6']['display_units'] = mcf.cb_eci_6_units.get()
    if mcf.eci_1_units == 'liters(l)' or mcf.eci_1_units == 'ml(l)' or mcf.eci_1_units == 'liters(g)' or mcf.eci_1_units == 'ml(g)':    #liters(l) liters(g) ml(l) ml(g
        if mcf.cb_1_Temp_Units.get() == "":
            eci_1_temp_units = mcf.cb_1_Temp_Units.set('K')
        if mcf.b_1_Press_Units.get() == "":
            eci_1_press_units = mcf.cb_1_Press_Units.set('ATM')
    # elif not eci_1_units == 'liters(g)' and not eci_1_units == 'ml(g)':
    #     print('cb_eci_1_units are ', eci_1_units)
    if mcf.eci_2_units == 'liters(l)' or mcf.eci_2_units == 'ml(l)' or mcf.eci_2_units == 'liters(g)' or mcf.eci_2_units == 'ml(g)':
        if mcf.cb_2_Temp_Units.get() == "":
            eci_2_temp_units = mcf.cb_2_Temp_Units.set('K')
        if mcf.cb_2_Press_Units.get() == "":
            eci_2_press_units = mcf.cb_2_Press_Units.set('ATM')
    if mcf.eci_3_units == 'liters(l)' or mcf.eci_3_units == 'ml(l)' or mcf.eci_3_units == 'liters(g)' or mcf.eci_3_units == 'ml(g)':
        if mcf.cb_3_Temp_Units.get() == "":
            eci_3_temp_units = mcf.cb_3_Temp_Units.set('K')
        if mcf.cb_3_Press_Units.get() == "":
            eci_3_press_units = mcf.cb_3_Press_Units.set('ATM')
    if mcf.eci_4_units == 'liters(l)' or mcf.eci_4_units == 'ml(l)' or mcf.eci_4_units == 'liters(g)' or mcf.eci_4_units == 'ml(g)':
        if mcf.cb_4_Temp_Units.get() == "":
            eci_4_temp_units = mcf.cb_4_Temp_Units.set('K')
        if mcf.cb_4_Press_Units.get() == "":
            eci_4_press_units = mcf.cb_4_Press_Units.set('ATM')
    if mcf.eci_5_units == 'liters(l)' or mcf.eci_5_units == 'ml(l)' or mcf.eci_5_units == 'liters(g)' or mcf.eci_5_units == 'ml(g)':
        if mcf.cb_5_Temp_Units.get() == "":
            eci_5_temp_units = mcf.cb_5_Temp_Units.set('K')
        if mcf.cb_4_Press_Units.get() == "":
            eci_5_press_units = mcf.cb_5_Press_Units.set('ATM')
    if mcf.eci_6_units == 'liters(l)' or mcf.eci_6_units == 'ml(l)' or mcf.eci_6_units == 'liters(g)' or mcf.eci_6_units == 'ml(g)':
        if mcf.cb_6_Temp_Units.get() == "":
            eci_6_temp_units = mcf.cb_6_Temp_Units.set('K')
        if mcf.cb_6_Press_Units.get() == "":
            eci_6_press_units = mcf.cb_6_Press_Units.set('ATM')
    eci_d['eci_1']['display_temp_units'] = mcf.cb_1_Temp_Units.get()
    eci_d['eci_2']['display_temp_units'] = mcf.cb_2_Temp_Units.get()
    eci_d['eci_3']['display_temp_units'] = mcf.cb_3_Temp_Units.get()
    eci_d['eci_4']['display_temp_units'] = mcf.cb_4_Temp_Units.get()
    eci_d['eci_5']['display_temp_units'] = mcf.cb_5_Temp_Units.get()
    eci_d['eci_6']['display_temp_units'] = mcf.cb_6_Temp_Units.get()
    eci_d['eci_1']['display_press_units'] = mcf.cb_1_Press_Units.get()
    eci_d['eci_2']['display_press_units'] = mcf.cb_2_Press_Units.get()
    eci_d['eci_3']['display_press_units'] = mcf.cb_3_Press_Units.get()
    eci_d['eci_4']['display_press_units'] = mcf.cb_4_Press_Units.get()
    eci_d['eci_5']['display_press_units'] = mcf.cb_5_Press_Units.get()
    eci_d['eci_6']['display_press_units'] = mcf.cb_6_Press_Units.get()
...
def vol_from_prt():
    ...
    if eci_1_temp_units.get() == 'C':
        T = 273.15 + float(mcf.e_Temp_Qty_1.get())  #C_to_K(float(e_Temp_Qty_1.get())) got TypeError: unsupported operand type(s) for *: 'float' and 'NoneType'
    elif eci_1_temp_units.get() == 'K':
        T = float(mcf.e_Temp_Qty_1.get())
    if eci_1_press_units.get() == 'ATM':
        P = float(mcf.e_Press_Qty_1.get())
    elif eci_1_press_units.get() == 'torr':
        P = float(mcf.e_Temp_Qty_1.get()) * 760
    vol = n*R*T/P
    mcf.e_eci_1_qty.delete(0, 'end')
    mcf.e_eci_1_qty.insert(0, vol)
    #print(n, T, P, vol)
...
def callback_set_temp_units(eventObject):
    ...
    eci_1_temp_units = mcf.cb_1_Temp_Units.get()
    eci_2_temp_units = mcf.cb_2_Temp_Units.get()
    eci_3_temp_units = mcf.cb_3_Temp_Units.get()
    eci_4_temp_units = mcf.cb_4_Temp_Units.get()
    eci_5_temp_units = mcf.cb_5_Temp_Units.get()
    eci_6_temp_units = mcf.cb_6_Temp_Units.get()
    eci_d['eci_1']['display_temp_units'] = mcf.cb_1_Temp_Units.get()
    eci_d['eci_2']['display_temp_units'] = mcf.cb_2_Temp_Units.get()
    eci_d['eci_3']['display_temp_units'] = mcf.cb_3_Temp_Units.get()
    eci_d['eci_4']['display_temp_units'] = mcf.cb_4_Temp_Units.get()
...
def callback_set_press_units(eventObject):
    ''' Whenever a temperature units combo box is selected, update the eci_db variable. '''
    eci_1_press_units = mcf.cb_1_Press_Units.get()
    eci_2_press_units = mcf.cb_2_Press_Units.get()
    eci_3_press_units = mcf.cb_3_Press_Units.get()
    eci_4_press_units = mcf.cb_4_Press_Units.get()
    eci_5_press_units = mcf.cb_5_Press_Units.get()
    eci_6_press_units = mcf.cb_6_Press_Units.get()
    eci_d['eci_1']['display_press_units'] = mcf.cb_1_Press_Units.get()
    eci_d['eci_2']['display_press_units'] = mcf.cb_2_Press_Units.get()
    eci_d['eci_3']['display_press_units'] = mcf.cb_3_Press_Units.get()
    eci_d['eci_4']['display_press_units'] = mcf.cb_4_Press_Units.get()
...
def Parse_Compounds():  # 'He2SO4'
    ...
    '''
    eci_1 = mcf.cb_eci_1.get()
    compound = mcf.cb_eci_1.get()
    # compound = 'H2O'    #'He2SO4'
    mcf.e_Explanation.insert(tk.END, "Parse_Compounds process entered\n")
    if compound == "":
        pass
    else:
...
def CountElements():  # The following does not work. Need valid test for value
    mcf.e_Explanation.insert(tk.END, "CountElements process entered\n")
    intElementCount = 0
    eci_1 = mcf.cb_eci_1.get()
    eci_2 = mcf.cb_eci_2.get()
    eci_3 = mcf.cb_eci_3.get()
...
def show_hide_instructions():
    if mcf.btn_show_instructions.text == 'Show Instructions':
        ''' What code changes button text? '''
        mcf.btn_show_instructions.text == 'Hide Instructions'
