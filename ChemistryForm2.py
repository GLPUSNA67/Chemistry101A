...
def set_element1():
    ...
    #txt_Explanation(root, text=element1)
...
btn_Compose = Button(root, text = 'Compose')
...
e_CompPressQty1 = Entry(root, text="ecpq1", width=6)
...
print(cb_Elements1.current(), cb_Elements1.get())

'''
lbl_Space1 = Label(root, text="123456", width=6)
lbl_Space1.grid(row=5, column=0)
lbl_Space1.config(font=labelfont)
lbl_Space2 = Label(root, text="123456", width=6)
lbl_Space2.grid(row=5, column=1)
lbl_Space2.config(font=labelfont)
lbl_Space3 = Label(root, text="123456", width=6)
lbl_Space3.grid(row=5, column=2)
lbl_Space3.config(font=labelfont)
lbl_Space4 = Label(root, text="123456", width=6)
lbl_Space4.grid(row=5, column=3)
lbl_Space4.config(font=labelfont)
lbl_Space5 = Label(root, text="123456", width=6)
lbl_Space5.grid(row=5, column=4)
lbl_Space5.config(font=labelfont)

def make_Title_Frame(Frame):
    def __init__(self, parent=root):
        Frame.__init__(self, root)
        self.pack()
        #Frame.config(row=0, column=0)
        Label(self, text="Frame Chemistry").pack(side=TOP)
        #lbl_Title = Label(self, text="Frame Chemistry")
        #lbl_Title.self.top.pack()
...
if __name__ == '__main__':
    ...
    #element1 = Combobox(cb_Elements1.get())
    #set_element1()
    print('Element1 value is ', element1)

'''
        cbElements1 is a combobox with a list of chemical elements
        strElement1 is a variable set to the value of the item selected in the combobox
        The following Visual Basic Code sets the value of a variable 'strElement1'
        to the value of the item selected in the combobox
        VB Code is:
        strElement1 = cbElements1.SelectedItem
        rtbElements1.Text = strElement1
